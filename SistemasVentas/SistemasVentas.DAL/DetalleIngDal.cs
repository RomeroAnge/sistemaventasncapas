...
namespace SistemasVentas.DAL
{
    public class DetalleIngDal
    {
        ...
        {
            string consulta = "SELECT    DETALLEING.IDDETALLEING, (PRODUCTO.NOMBRE)PRODUCTO, (INGRESO.FECHAINGRESO) FECHAINGRESO, DETALLEING.FECHAVENC, DETALLEING.CANTIDAD, DETALLEING.PRECIOCOSTO, DETALLEING.PRECIOVENTA, " +
